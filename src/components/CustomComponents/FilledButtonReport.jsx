      ...
      <div className="filled-button-report">
        <NavLink to={link[0]} className="color-white">
          <Row className="above-div">
            ...
            <Col lg={12} style={{ display: "flex", justifyContent: "start" }}>
              <div className="filled-title">{title[0]}</div>
              <br />
            </Col>
            <Col lg={12} style={{ display: "flex", justifyContent: "start" }}>
              <Col lg={6} xs={6} sm={6} md={6} className="filled-data">
                {totalData[0]}
              </Col>
              <Col lg={6} xs={6} sm={6} md={6} className="filled-data">
                {totalData[1]}
            ...
            <Col lg={12} style={{ display: "flex", justifyContent: "start" }}>
              {title[0] !== "Total Sales" && (
                <>
                  <Col lg={6} xs={6} sm={6} md={6} className="filled-subtitle">
                    Today
                  </Col>
                  <Col lg={6} xs={6} sm={6} md={6} className="filled-subtitle">
                    Total
        ...
        <NavLink to={link[1]} className="color-white">
          <Row className="below-div">
            ...
            <Col lg={12} style={{ display: "flex", justifyContent: "start" }}>
              <div className="filled-title">{title[1]}</div>
              <br />
            </Col>
            <Col
              lg={12}
            ...
            >
              {title[1] === "Total Sales" ? (
                <>
                  <Col lg={6} className="filled-data">
                    P {totalData[2]}
                  </Col>
                </>
              ) : (
            ...
            <Col lg={12} style={{ display: "flex", justifyContent: "start" }}>
              {title[1] !== "Total Sales" && (
                <>
                  <Col lg={6} className="filled-subtitle">
                    Today
                  </Col>
                  <Col lg={6} className="filled-subtitle">
                    Total
