...
function AddCompany() {
  ...
  const [isHMO, setHMO] = useState(false)
  //GET OPTION DETAILS
  React.useEffect(() => {
    labOptions.length = 0
  ...
  function submit(e, company, discount) {
    ...
    if (
      company.name != "" &&
      company.address != "" &&
      (company.contact_person != "" + company.contact_no) != "" &&
  ...
  return (
    <div>
      ...
      <div className="active-cont">
        <Header type="thin" title="ADD COMPANY" />
          ...
          <form>
            <div className="row">
              ...
              <div className="col-sm-6 mt-4 pt-3">
                <input
                  ...
                  name="is_hmo"
                  checked={isHMO}
                  onChange={(e) => setHMO(!isHMO)}
                />{" "}
                <label for="is_hmo" className="md-booking-label font-large">
                  Is HMO?
                </label>
              </div>
            </div>
            <div className="row">
              <div className="col-sm-12">
                <label for="company_address" className="form-label">
            ...
            <div className="row">
              <div className="col-sm-6">
                <label for="company_contact_no" className="form-label">
            ...
            {applyToall == "no" && (
              <div className="row">
                <div className="col-sm-11">
                  <label for="discount_code" className="form-label">
                    APPLY DISCOUNT TO LAB SERVICE/S:{" "}
                  </label>
                  <br />
                  <MultiSelect
                    options={labOptions}
            ...
            <div className="row">
              <div className="col-sm-12 d-flex justify-content-end">
                <button
                  className="save-btn"
                  onClick={(e) => submit(e, company, discount)}
                >
                  SAVE
                </button>
              </div>
