        ...
        <div className="receipt-cont">
            ...
            <div className="receipt-details">
                ...
                <span className="received-from-cont">
                    ...
                    <span className="received-from-detail"> {this.props.paidAmount ? numToWords(amount[0],false).toUpperCase() + numToWords(amount[1], true).toUpperCase() : ""} <span className="decimal-amount-form">(Php {this.props.paidAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")})</span> </span>
                </span>
                <br/>
                <span className="received-from-cont">
