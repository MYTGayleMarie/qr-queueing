        ...
        btn = buttons.map((button) => {
            ...
            if (button.includes("add-")) {
                ...
                if(button === 'change-password') {
                    ...
                    return <button className="edit-profile" onClick={editPackage}> EDIT PACKAGE</button>
                }
                else if(button === 'delete-package') {
                    return <button className="edit-profile" onClick={deletePackage}> DELETE PACKAGE</button>
                }
    ...
    return (
        <div className={title + ' header ' + type}>
            <div className='row'>
                ...
                {title}
                {withBack && (
                    <button className='back-btn-header' onClick={() => setBack(true)}>BACK</button>
                )}
                {btn}
                </div>
            </div>
