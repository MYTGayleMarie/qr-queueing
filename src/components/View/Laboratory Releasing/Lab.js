   ...
   return (
    <div>
      ...
      <div className="active-cont">
        <Fragment>
          <Header type="thick" title="LABORATORY RELEASING MANAGER" buttons={buttons} tableData={patientData}/>
          ...
          <Table
            ...
            rowsPerPage={20}
            headingColumns={['WITH DISCOUNT', 'BOOKING ID', 'PATIENT NAME', 'BOOKING DATE','PAYMENT STATUS']}
