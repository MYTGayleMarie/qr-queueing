...
function Form3CModule({ service, customer, location, packagePrice, labPrice,  setPackagePrice, setLabPrice, isService, isPackage, discount, setDiscount, isCompany, setServices, lastMeal, navigation, mdCharge, serviceFee, dateOfTesting, discountDetails }) {
    //get all lab tests
