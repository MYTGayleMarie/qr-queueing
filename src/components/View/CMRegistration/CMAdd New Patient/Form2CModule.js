...
function Form2CModule({ service, customer, packagePrice, labPrice,  setPackagePrice, setLabPrice, isService, isPackage, discount, setDiscount, isCompany, setServices, lastMeal, navigation, serviceFee, mdCharge, discountDetails}) {
      //get all lab tests
...
{console.log(checkedServicesDetails)}
            <div className="row summary-text">
                    <h3 className="form-categories-header italic medium-text ">TOTAL SUMMARYyy</h3>
