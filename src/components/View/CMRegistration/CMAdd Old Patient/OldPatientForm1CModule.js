...
//css
import './OldPatientForm1CModule.css';

const userToken = getToken();
const userId = getUser();

function OldPatientForm1CModule({ customer, setPersonal, setIsService, setIsPackage, discount, setDiscount, setIsCompany, lastMeal, setLastMeal, navigation, mdCharge, setMdCharge, serviceFee, setServiceFee, location, setLocation, dateOfTesting, setDOT, discountDetails, setDiscountDetails  }) {
    ...
    <div>
        {/* <Navbar/> */}
        <div className="active-cont" style={{marginRight:"15%",}}>
...
export default OldPatientForm1CModule
