...
import {
  ...
  getSingleXRAYExtractionPatients,
  skipPatient,
...
export default function XRAYExtractionUpdate() {
  ...
  async function fetchExtraction() {
    const response = await getSingleXRAYExtractionPatients(bookingId)
  ...
  async function handleUpdateBooking() {
    const response = await updateExtractionXRAYPatientBulk(details)
    if (response.data) {
      ...
      <div className="active-cont">
        {loading ? (
          ...
          <Fragment>
            <Header
              type="thick"
              title={`EXTRACTION(XRAY) - BOOKING ${bookingId}`}
            />
